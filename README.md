...
```bat
curl -L https://github.com/Diramix/Genius-Client/releases/download/Genius-Client-1.3.0/app.asar > %localappdata%/Programs/YandexMusic/resources/app.asar
```

Команда для установки версии с системной рамкой
```bat
curl -L https://github.com/Diramix/Genius-Client/releases/download/Genius-Client-1.3.0/app-wsf.asar > %localappdata%/Programs/YandexMusic/resources/app.asar
```
3. Готово!
